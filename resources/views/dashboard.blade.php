        ...
        <div class="row">
            <div class="col-xl-6">
                ...
                <div class="card card-default todo-table" id="todo">
                    <div class="pb-0 card-header d-block ">
                        <div class="mb-0 todo-single-item" id="todo-input">
                            <form class="todo-form">
                                <div class="mb-0 input-group">
                                    <input type="text" class="form-control border-right-0" placeholder="Add Todo"
                                        required="" autofocus>
                                    <div class="ml-0 input-group-append">
                                        <button class="border-0 input-group-text btn bg-primary" type="submit">
                                            <?xml version="1.0"?>
                    ...
                    <div class="card-body compact-to-do-list" data-simplebar style="height: 450px;">
                        <div class="todo-list" id="todo-list">
                            <div id="item"
                                class="flex-row todo-single-item todo-item d-flex justify-content-between finished alert alert-dismissible fade show"
                                role="alert">
                                <i class="mdi"></i>
                            ...
                            <div class="flex-row todo-single-item d-flex justify-content-between current alert alert-dismissible fade show"
                                role="alert">
                                <i class="mdi"></i>
                            ...
                            <div class="flex-row todo-single-item d-flex justify-content-between alert alert-dismissible fade show"
                                role="alert">
                                <i class="mdi"></i>
                            ...
                            <div class="flex-row mb-1 todo-single-item d-flex justify-content-between alert alert-dismissible fade show"
                                role="alert">
                                <i class="mdi"></i>
                                <span>Update parallax scroll on team page</span>
